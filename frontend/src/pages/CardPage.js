    ...
    return (
        <Container>
            <Grid container spacing={3}
                ...
                <Grid item xs={6}>
                    <JobCard title={'Schweißen'} image_source={'./job_images/schweißen.jpg'} description={'Geprüfte Schweißer/innen verbinden Metallteile und montieren Anlagen- und Konstruktionsbauteile mittels unterschiedlicher Schweißverfahren.'}/>
                </Grid>
                <Grid item xs={6}>
